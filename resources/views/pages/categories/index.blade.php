        ...
        <div class="col-xxl-12">
            ...
            <div class="d-flex flex-wrap justify-content-between pb-6 bg-green-800">
                ...
                <div class="d-flex flex-wrap">
                    <a href="#" class="card hover-elevate-up shadow-sm parent-hover" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_create_category">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span
                                                class="text-muted fw-semibold text-muted d-block fs-7">{{ $category->name }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span
                                                class="text-muted fw-semibold text-muted d-block fs-7">{{ Str::limit($category->description, 150) }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <span
                                                class="badge badge-{{ $category->status == 'active' ? 'success' : 'danger' }}">{{ ucfirst($category->status) }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <a href="#" data-id={{ $category->id }}
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="save_cat" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control" placeholder="{{ __('Kategori Adı') }}"
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control" rows="5" name="category_description" id="category_description"
                                placeholder="{{ __('Kategori Açıklama') }}"></textarea>
                        </div>
                        <!--end::Input group-->
    ...
    <div class="modal fade" id="kt_modal_update_category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="update_cat" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        enctype="multipart/form-data" action="#">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control" placeholder="{{ __('Kategori Adı') }}"
                                id="cat_name" name="category_name">
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8">
                            ...
                            <textarea class="form-control" rows="10" name="category_description" id="cat_description"
                                placeholder="{{ __('Kategori Adı') }}"></textarea>
                        </div>
                        <!--end::Input group-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <form action="">
                        ...
                        <div class="text-center pt-10">
                            <button class="btn btn-danger mr-1 delete_category"
                                type="submit">{{ __('Sil') }}</button>
                        </div>
                    </form>
                ...
                $(".edit").click(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (status == 'active') {
                                $("input[name=category_status][value=" + status + "]").prop(
                                    'checked', true);
                            }
                            if (status == 'inactive') {
                                $("input[name=category_status][value=" + status + "]").prop(
